#!/usr/bin/python3
"""
   Copyright Krzysztof Miernik 2018
   k.a.miernik@gmail.com 
   
   Distributed under GNU General Public Licence v3
   
   This Python script loads data from NuBase16 ascii file
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Reads NuBase2016 ascii file and writes xml document')
    ...
    for line in args.infile:
        ...
        mass_defect = line[18:42].strip()
        isomer_data = line[42:69].strip()
        half_life = line[69:88].strip()
        spin = line[88:102].strip()
        comment = line[102:118].strip()
